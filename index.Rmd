...
for (x in 1:nsims){
  ...
  TrumpNPVWinVector[x] <- weighted.mean(trumpstateresults[1,],data$EV.s)
  BidenNPVWinVector[x] <- weighted.mean(bidenstateresults[1,],data$EV.s)
  OtherNPVWinVector[x] <- weighted.mean(otherstateresults[1,],data$EV.s)
  if (TrumpVoteEV>=270){
  ...
  function(st, vts, dem, rep, w) {
    htmltools::HTML(
      sprintf("<div style='font-family:futura;font-size:14px;width:200px;float:left'>
            ...
            <br/><span style='font-size:13px'>%s Electoral Votes</span>
