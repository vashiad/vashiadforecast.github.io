...
nationalproj$Date <- as.Date(nationalproj$Date,"%Y-%m-%d")
...
htmltools::HTML('<div style="font-family:futura; font-size: 30px; width: 900px; float: left;" id="Header">
<strong>State Outcomes<br> <span style="font-size: 16px;" </span> The highlighted bars represents an 80% chance that the margin of victory will lie inside the range. </strong> <hr>
</div>')
