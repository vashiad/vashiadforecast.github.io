...
# To update site: rmarkdown::render_site()
```
...
writeLines(paste(Sys.time(),Sys.Date()),"check.txt")
...
writeLines(paste(Sys.time(),Sys.Date()),"check2.txt")
#Percentiles
...
writeLines(paste(Sys.time(),Sys.Date()),"check3.txt")
...
writeLines(paste(Sys.time(),Sys.Date()),"check4.txt")
