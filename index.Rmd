...
```{r,fig.width = 8, fig.asp = 0.8, fig.align = "left"}
df <- data.frame("Candidate" <- c("Joe Biden","Donald Trump","Others"),
           "Electoral votes" <- c(round(mean(finalEV$BidenEV),1),round(mean(finalEV$TrumpEV),1),0.0),
...
```{r, out.width="90%", out.height="10%", fig.align = "center"}
...
```{r, fig.width = 10, fig.asp = 2,  out.width="100%", out.height="50%", fig.align = "center"} 
