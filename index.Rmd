---
title: "The Presidential Forecast"
...
nationalupdatedcsv <- data.frame("Date" <- as.character(Sys.time()),
                                ...
                                "LowTrump" <- quantile(finalEV$TrumpEV,0.20),
                                "HighTrump" <- quantile(finalEV$TrumpEV,0.80),
                                "LowBiden" <- quantile(finalEV$BidenEV,0.20),
                                "HighBiden" <- quantile(finalEV$BidenEV,0.80),
                                "LowOther" <- quantile(finalEV$OtherEV,0.20),
                                "HighOther" <- quantile(finalEV$OtherEV,0.80))
...
ggplotly(p4) %>%
  layout(margin = list(t=47),xaxis=list(side="top",size=14),
         font = list(family='Futura', size=16),
         xaxis = list(side="top",fixedrange=TRUE),
